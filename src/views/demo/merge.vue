<template>
  <Codemirror
    ...
    @ready="onReady"
    original-style
    @before-selection-change="onBeforeSelectionChange"
    :border="false"
  />
</template>
<script lang="ts">
...
export default defineComponent({
  ...
  <meta data-n-head="ssr" charset="utf-8">
    ...
    return {
      ...
      onBeforeSelectionChange(instance: Editor, obj: EditorSelectionChange) {
        console.log("onBeforeSelectionChange", instance, obj);
      },
    };
  },
});
